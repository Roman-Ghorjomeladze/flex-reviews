...
function ReviewCard({ review }: ReviewCardProps) {
	...
	return (
		<div className="review-card">
			<div className="review-header">
				<div className="reviewer-info">
					{review.userId && review.userId.trim() !== "" ? (
						<Link to={`/user/${review.userId}`} className="reviewer-name-link">
				...
				{review.overallRating !== null && (
					<div className="review-rating" style={{ backgroundColor: getRatingColor(review.overallRating) }}>
			...
			<div className="review-type">{review.type === "guest-to-host" ? "Guest Review" : "Host Review"}</div>
		</div>
	);
}
